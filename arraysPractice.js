...
function addTen (numbers) {
  var array = numbers.map(function(x) {
    return Number(x) + 10;
  });
return array;
}
...
var user2 = {
    name: 'Giao McGinnis',
    email: 'giaomcginnis33@gmail.com',
    password: 'giaoLoveJavaScript',
    username: 'giaoinfiniateLoop'
};

var user3 = {
    name: 'shiv McGinnis',
    email: 'shivmcginnis33@gmail.com',
    password: 'shivLoveJavaScript',
    username: 'shivinfiniateLoop'
};
